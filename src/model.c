...
extern void print_branchliterals(world_t* world) ;
extern void destroy_world(world_t** world);
...
void generatemodel() {
    ...
    HASH_SRT(hml, mlbranches, ml_branches);
...
void instantiate_world(world_t* world, int id) {
    /*world = malloc(sizeof(world_t));*/
    world->id = id;
    world->literals = NULL; 
    world->positives = NULL; 
    world->negatives = NULL; 
}
